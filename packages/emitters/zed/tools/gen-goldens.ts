/**
 * Golden regenerator for the zed fixture suite (T032).
 *
 * Usage: bun packages/emitters/zed/tools/gen-goldens.ts
 *
...
import { compileZed, snapshotPaths } from "../src/index.ts";
